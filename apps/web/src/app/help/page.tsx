        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              We're building a comprehensive help center with FAQs, guides, tutorials, and support resources. This
              section is currently under development.
            </p>

            <Badge className="bg-primary/10 text-primary border-primary/20 mb-8">Under Development</Badge>
              ...
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Step-by-step tutorials for new users</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Visual guides for all features</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Mail className="h-6 w-6 text-primary mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900">Support Articles</h4>
                    <p className="text-gray-600 text-sm">Detailed troubleshooting guides</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200 mb-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Need Help Right Now?</h3>
              <p className="text-gray-600 mb-4">
                While we're building our help center, you can reach out to us directly:
              </p>
