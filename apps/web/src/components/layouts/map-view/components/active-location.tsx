...
import { ChevronDown, ChevronUp, Clock, ExternalLink, Globe, Pencil, Phone, Plus } from "lucide-react";
import Image from "next/image";
import { useMemo, useState } from "react";

const ActiveLocation = () => {
  const { markers, activeLocation, setActiveLocation, setActiveState, collections, collectionLinks } =
    ...
    <div className="p-4">
      ...
      <div className="flex items-start gap-3 mb-2">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-medium text-gray-900">{activeLocation.title}</h1>
      ...
      <div className="space-y-3 text-sm">
        ...
        {activeLocation.place.phone && (
          <div className="flex items-center gap-3">
            ...
            <a href={`tel:${activeLocation.place.phone}`} className="text-blue-600 hover:underline">
              {activeLocation.place.phone}
            </a>
          </div>
        )}
      ...
      {/* Collections section */}
      {isSaved && collectionsForLocation && collectionsForLocation.length > 0 && (
        <div className="mb-3">
          <p className="text-sm font-medium text-gray-700 mb-1">In collections:</p>
      ...
      {activeLocation.note && (
        <div className="mb-3">
          ...
          <div className="rounded-md w-full border border-gray-200 bg-gray-50 p-3 text-sm">{activeLocation.note}</div>
        </div>
      )}
    </div>
  </div>
